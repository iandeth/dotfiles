# via https://github.com/jondavidjohn/dotfiles/blob/41bb2f84429cde521383590d7ec72ed1531e78c9/general/.bash_profile#L42-L138
GREEN="\[\e[0;32m\]"
BLUE="\[\e[0;34m\]"
RED="\[\e[0;31m\]"
BRED="\e[1;31m\]"
...
parse_git_branch() {
    if [[ -f "${BASH_EXT_DIR}/git-completion.bash" ]]; then
        branch=`__git_ps1 "%s"`
    else
